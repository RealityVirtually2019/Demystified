...
namespace MagicLeap.Utilities
{
	...
	public class Placement : MonoBehaviour
	{
		...
		private Func<Vector3, Quaternion, bool> _customRule;
		...
		private void Update()
		{
			...
			if (_customRule != null)
			{
				customRuleResult = _customRule(Position, Rotation);
			}
		...
		/// </summary>
		public void Place(Transform placementSource, System.Action<Vector3, Quaternion> callback, Func<Vector3, Quaternion, bool> customRule = null)
		{
			if (Running) return;
